...
export const CONVERSATIONS_COLLECTION_ID = process.env.CONVERSATIONS_COLLECTION_ID;
export const USER_CONVERSATIONS_COLLECTION_ID = process.env.USER_CONVERSATIONS_COLLECTION_ID;
