import LogoutButton from "@/app/(auth)/check-email-confirmation/_components/LogoutButton";
import ResendButton from "@/app/(auth)/check-email-confirmation/_components/ResendButton";
