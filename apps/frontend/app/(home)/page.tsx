...
//           <button
//             aria-label={
//               openHamburflexeitems centerse the sidebar" :pxn4 py-1idebar"
//             }
//             onClick={() => setOpenHamburgerMenu((prev) => !prev)}
//             className=" rotate-180 z-50 "
//           >
//             <HamburgerIcon open={openHamburgerMenu} />
//           </button>flexitemscenterpx4 py-1

//           <div
//             data-state={z-50 openHamburnu ? "open" : "closed"}
...
//           >
//             <div classNdata-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 ame="flex justify-between h-full flex-col">animate
//               <ul className="flex flex-col gap-2">
//                 {navigationLinks.map((link) => (
//                   <li key={link} className="py-2 flex items-center gap-2 px-2">
//                     <adata-[state=closed]:slide-out-to-rightdata-[state=open]:slidein-from-rightmd:data[state=closed]:slide-out-to-rightmd:data-[state=open]:slide-in-from-right fixed bordersolidbgwhitepx4 py8pt14transitioneaseinanimateanimatedataduration300dataduration500
//                       onClick={() => setOpenHamburgerMenu(false)}
//                       href={`#${l justify-between
...
//                 <Button className="w-1/2" va={"secondary"}> py-2
//                   Signupf
//                 </Button>
...
//                 pen testing flexs emp-colower yopx 4n networks, websites, and
//                 systems with of a skilled hacker andtext-gray-900  the ethics of
//                 a trusted guardian.
//               </p>
//               <EncryptButton /> leading-7
//             </div>
//             <div className="px-4">
//               <video
//                 muted
...
//                 loop
//               >
//                 <source src={getPublicURl('public-assets', 'demo.webm', process.env.MINIO_HOST_URL!, process.env.NODE_ENV === 'production' ?  "https" : "http",)} type="video/webm"></source>
//               </video>
//             </div>
//           </div>
...
//               </h3>
//             </div>flex flexcolgap4pxpt16
//             <p className="mt-1 text-[18px] leading-7 text-gray-600">
//               Equip yourself with our comprehensred-500e suitsmn testing tools.
...
//       </p>
//       <div>
//         <Carousel className="cursor-g:cursor-grabb leading-7ing">
//           <CarouselContent>
...
//         {navigationLmtk40link) => (px-4 py12
//           <li key={link}>
...
//             <div className="fhb[432px]xt-base texoverflow-hidden{role}</div>
//             <div className="text-s>{bio}</div> object-cover
//           </div>absolute bottom0left-0 z10w-full translate-y-full roundedb-lgbgwhitebgopacity30 px5py6backdrop-blur grouphover:translateygrouphover:opacity100
//         </div>

//         <ul className="flex gap-5">
//           {socials.map(({ namh [432px]) => (overflowhidden
//             <li key={name}> object-cover
//               <Link arabsolute bottom-0aleft-0 zl10{`${naw-full translate-y-full me} profile linrounded>b-lgbgwhitebgopacity30 px5py6backdrop-blur grouphover:translateygrouphover:opacity100
//                 <img
//                   src={icon.src}
//                   alt=""
...
//         }}h-[350px] roundedlgborder-solid p4
...
//         <h4h-[350px] roundedlgborder-solid p4
//           classNameflex h-14 ={`foitems-center justifytcentereroundedtlgansition-colors ${hovered ? "text-wtransition colors
//         >
//           {title}
//         </h4>
//         <pflex-col
//           className={`font-medium  transition-colors ${hovered ? "text-gray-300" : "text-gray-700"}`}
//         >flex h-14 items-center justifycenterroundedlgtransitioncolors
//           {description}
//         </p>
//       </div>
//       <AnimatePresence>flex-col
//         {hovered && (
//           <motion.div
//             initial={{ opacity: 0 }}
//             animate={{ opacity: 1 }}
...
//           className={
//             "flex  h-fit justify-center text-[46px] font-bolflex-col d md:p-8 md:text-3xl lg:p-10 lg:text-4xl xl:text-5xl"
//           }
//         >
//           {words.map((word, i) => {
//             const start = (i / words.length) * (2 / 5);
//             const end = start + 2 / 5 / words.length;
//             consolog("stajustifytcenter,font bold "end: ", eflex-col n
//             return (
