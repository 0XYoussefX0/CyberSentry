    ...
    <>
      ...
      {createPortal(
        <>
          ...
          <nav
            data-state={openSideBar ? "open" : "closed"}
            className="fixed inset-y-0 left-0 z-40 flex min-h-screen w-screen flex-col justify-between border-r border-solid border-r-gray-200 bg-white px-4 py-8 transition ease-in-out fill-mode-forwards data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left sm:max-w-[312px] md:w-full"
          >
